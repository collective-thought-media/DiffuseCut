...
```
You are running the DiffuseCut representative E2E eval in this DiffuseCut checkout.

Read doc/E2E-AGENT-PLAYBOOK.md completely before acting.

Hard rules:
1. Create a NEW isolated project only (name like "E2E Eval ..."). Never modify other existing projects.
