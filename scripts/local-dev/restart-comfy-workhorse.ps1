# Restart ComfyUI on workhorse and verify Woosh nodes.
...
foreach ($node in @("WooshLoadFlow", "WooshSample", "WooshTextEncode")) {
  if ($obj.PSObject.Properties.Name -contains $node) {
