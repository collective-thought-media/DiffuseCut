...
export const SHOT_INTEGRATE_IN_SCENE_SUFFIX =
  "the character clearly visible in the frame, opaque solid subject fully formed with no transparency, subject present in the scene, subject generated in the same environment as the location reference, matching scene lighting and depth, photographed with the same lens, focal length, and camera height as the background plate, single consistent perspective, subject at a natural scale for their distance from the camera, correctly proportioned to the doorways, windows, and set pieces around them, grounded on the visible floor plane, on-location cinematic storyboard still, not a cutout composite";

export const SHOT_INTEGRATE_IN_SCENE_NEGATIVE =
  "empty scene, deserted street with no subject present, missing subject, character absent from frame, transparent subject, translucent body, ghosted figure, double exposure, see-through subject, subject blending into walls, morphing into background, pillar through subject, pasted cutout, floating subject, green screen composite, sticker on background, hard cutout edges, mismatched lighting direction, flat superimposed figure, halo around subject, bad composite, oversized subject, giant subject, subject too large for the scene, wrong scale, out of proportion with the environment";
