...
export function FinishingTimeline({
  projectId,
  shots,
  fps,
  selectedShotId,
      ...
      <div ref={viewportRef} className="relative overflow-hidden px-1 py-2">
        {shots.length === 0 ? (
          <p className="py-6 text-center text-sm text-muted-foreground">
            No shots on timeline. Add shots on the storyboard first.
          </p>
        ) : (
          <>
            <div
                    ...
                    {shots.map((shot, index) => (
                      <TrimShotClip
                        ...
                        onUpdateTrim={(trimIn, trimOut, previewEdge) =>
                          onUpdateTrim(shot.id, trimIn, trimOut, {
                            previewEdge: previewEdge ?? "none",
                          })
                        }
                      />
                    ))}
