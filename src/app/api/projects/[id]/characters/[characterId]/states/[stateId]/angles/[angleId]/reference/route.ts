...
import {
  applyCharacterAngleReferenceMedia,
  clearCharacterAngleReference,
...
export async function POST(req: NextRequest, { params }: RouteParams) {
  try {
    ...
    const result = await applyCharacterAngleReferenceMedia(
      projectId,
      characterId,
      stateId,
      angleId,
...
export async function DELETE(_req: NextRequest, { params }: RouteParams) {
  try {
    const { id: projectId, characterId, stateId, angleId } = await params;
    const angle = clearCharacterAngleReference(
      projectId,
      characterId,
      stateId,
      angleId
